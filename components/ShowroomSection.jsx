...
// Contact items: only the icon is visual; label/value/href pulled from messages.
const CONTACT_ITEMS = [
  {
    icon: (
        ...
        <div className={styles.layout}>
          ...
          >
            <div className={styles.mapFrame}>
              <iframe
                title={t('mapTitle')}
                src="https://maps.google.com/maps?q=22.3296222,91.7930853+(Heaven+Furniture+Mart)&output=embed&z=17&hl=en"
                loading="lazy"
                className={styles.mapIframe}
                allowFullScreen
                referrerPolicy="no-referrer-when-downgrade"
              />
              <div className={styles.mapRing} aria-hidden="true" />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className={styles.block}>
              <h3 className={styles.blockTitle}>{t('hoursTitle')}</h3>
            ...
            <div className={styles.block}>
              <h3 className={styles.blockTitle}>{t('reachUs')}</h3>
                    ...
                    <li key={item.labelKey}>
                      ...
                      >
                        ...
                        <span className={styles.contactText}>
                          <span className={styles.contactLabel}>{t(item.labelKey)}</span>
            ...
            <div className={styles.actions}>
              ...
              <a href="tel:+8801960481983" className={`btn btn-outline-dark ${styles.actionBtn}`}>
                {t('callShowroom')}
              </a>
